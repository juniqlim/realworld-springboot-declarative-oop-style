...
class CreateUserTest {
    @Test
    void saveAndFind() throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        User user = new CreateUser(userRepository, privateKey).user(new CreateUser.Request("Jacob", "jake@jake.jake", "jakejake"));
