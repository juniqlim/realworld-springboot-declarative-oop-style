...
class FindCommentTest {
    ...
    void test() {
        ...
        List<CommentResponse> comments = new FindComment(Fixture.COMMENT_REPOSITORY, new FindProfile(new FindUser(Fixture.USER_REPOSITORY), new FollowUser(Fixture.USER_REPOSITORY))).comments(
